...
CRISIS_MENU: dict = {
    ...
    "cyber_attack": {
        ...
        "parameters": {},
        "description_template": "Adversary cyber attack on {target}: readings corrupted for 6t",
    },
    "supply_disruption": {
        "cost": 20,
        "tier": "light",
        ...
        "requires_route": False,
        "parameters": {"output_modifier": 0.20},
        "description_template": "Adversary supply disruption: {target}/{source_id} at 20% output for 8t",
    },
    ...
    "storage_leak": {
        ...
        "requires_source": False,
        "requires_route": False,
        "parameters": {"leak_rate": 0.10},
        "description_template": "Adversary sabotage: {target} storage leaking 10%/tick for 10t",
    },
    "political_embargo": {
        "cost": 32,
        "tier": "medium",
        ...
        "requires_route": False,
        "parameters": {},
        "description_template": "Adversary embargo: trade route {target} frozen for 8t",
    },
    "worker_strike": {
        "cost": 35,
        "tier": "medium",
        ...
        "requires_source": True,
        "requires_route": False,
        "parameters": {"output_modifier": 0.10},
        "description_template": "Adversary-incited strike: {target}/{source_id} at 10% output for 10t",
    },
    "drought": {
        "cost": 40,
        "tier": "medium",
        ...
        "requires_route": False,
        "parameters": {"output_modifier": 0.10},
        "description_template": "Adversary-induced drought: {target} hydro at 10% for 10t",
    },
    ...
    "equipment_failure": {
        ...
        "requires_route": False,
        "parameters": {},
        "description_template": "Adversary sabotage: {target}/{source_id} equipment offline for 10t",
    },
    "heat_wave": {
        "cost": 50,
        "tier": "heavy",
        ...
        "requires_source": False,
        "requires_route": False,
        "parameters": {"demand_modifier": 1.80, "solar_output_modifier": 0.30},
        "description_template": "Adversary heat wave: {target} demand +80%, solar at 30% for 8t",
    },
    "transmission_surge": {
        "cost": 55,
        "tier": "heavy",
        ...
        "requires_source": False,
        "requires_route": False,
        "parameters": {"efficiency_reduction": 0.60},
        "description_template": "Adversary transmission surge: {target} routes -60% efficiency for 8t",
    },
    "wildfire": {
        "cost": 60,
        "tier": "heavy",
        ...
        "requires_source": True,
        "requires_route": True,
        "parameters": {"output_modifier": 0.05, "route_damage_per_tick": 25.0},
        "description_template": "Adversary wildfire: {target}/{source_id} nearly destroyed + route ablaze for 8t",
    },
    ...
    "regional_blackout": {
        ...
        "requires_source": False,
        "requires_route": False,
        "parameters": {"demand_modifier": 2.50},
        "description_template": "Adversary regional blackout: {target} region +150% demand surge for 7t",
    },
    "economic_recession": {
        "cost": 45,
        "tier": "heavy",
        ...
        "requires_source": False,
        "requires_route": False,
        "parameters": {"income_modifier": 0.15},
        "description_template": "Adversary economic attack: {target} income at 15% for 12t",
    },
}
...
class CrisisAgentNodes:
    ...
    def crisis_execute(self, state: CrisisAgentState) -> dict:
        ...
        for plan in state["planned_crises"]:
            ...
            # ── Budget check ──
            if cost > budget:
                print(f"  ✗ '{key}' on {target_id} — insufficient budget ({budget:.0f}cr < {cost}cr)")
            ...
            print(f"  ✓ '{key}' on {target_id} (cost: {cost}cr | remaining: {budget:.0f}cr)")
            executed.append({
                "crisis_key":  key,
                "target_id":   target_id,
                "cost":        cost,
